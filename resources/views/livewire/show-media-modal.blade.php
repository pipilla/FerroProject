<div>
    <x-button wire:click="set('openModal', true)">
        <i class="fas fa-add mr-2"></i><span class="font-semibold">Elegir archivos multimedia</span>
    </x-button>
                    ...
                    <x-dialog-modal wire:model="openUpdate">
                        ...
                        <x-slot name="content">
                            ...
                            <div class="relative">
                                ...
                                <i
                                    class="fas fa-tag absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-400"></i>
